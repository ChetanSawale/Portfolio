    ...
    if (toggle) {
        ...
        function updateIcon() {
            if (document.body.classList.contains("dark-mode")) {
                ...
                toggle.innerHTML = '<img src="sun.svg" alt="Toggle light mode" style="width: 24px; height: 24px;">';
            } else {
                // In light mode, show the moon icon
                toggle.innerHTML = '<img src="moon.svg" alt="Toggle dark mode" style="width: 24px; height: 24px;">';
            }
        }
